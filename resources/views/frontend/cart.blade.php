        ...
        @if($cartitems->count() > 0)
            ...
            <div class="card-footer">
                <h6>Total Price: Rs.{{$total}}
                    <a href="{{url('checkout')}}" class="btn btn-outline-success float-lg-right">Proceed to checkout</a>
                 </h6>
            </div>
        @else
            <div class="card-body text-center">
                <h2>Your <i class="fa fa-shopping-cart"></i>Cart Is Empty</h2>
                <a href="{{url('product')}}" class="btn btn-outline-primary float-lg-right">Continue Shopping</a>
            </div>
        @endif
